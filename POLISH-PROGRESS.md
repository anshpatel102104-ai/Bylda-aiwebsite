...
## Batch 4 — SEO — ✅ DONE (sitemap, OG+image, JSON-LD, canonicals; only optional title-trim left)
...
- [x] Clean canonical + og:url on 10 pages (/operations/*, /pricing/*, /bylda) — stripped .html to match cleanUrls.
