...
.np-box{background:#0B1220;border:1px solid rgba(14,165,233,.38);border-radius:22px;max-width:430px;width:100%;overflow:hidden;box-shadow:0 40px 100px rgba(0,0,0,.8),0 0 0 1px rgba(14,165,233,.12),inset 0 1px 0 rgba(255,255,255,.04);transform:scale(.88) translateY(24px);transition:transform .35s cubic-bezier(.34,1.56,.64,1);position:relative}
.np-backdrop.np-visible .np-box{transform:scale(1) translateY(0)}

.np-hero{padding:30px 26px 22px;background:linear-gradient(160deg,#0E1A2E 0%,#1e0848 55%,#2d0a5e 100%);text-align:center;position:relative;overflow:hidden}
.np-hero::before{content:'';position:absolute;top:-60px;left:50%;transform:translateX(-50%);width:300px;height:180px;background:radial-gradient(ellipse,rgba(14,165,233,.22) 0%,transparent 70%);pointer-events:none}
...
.np-hero h2 em{font-style:normal;background:linear-gradient(135deg,#38BDF8,#0EA5E9);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
.np-hero p{font-size:.85rem;color:rgba(255,255,255,.65);line-height:1.55;margin:0}

.np-deal{background:rgba(14,165,233,.1);border:1px dashed rgba(14,165,233,.35);border-radius:12px;margin:16px 22px 0;padding:11px 15px;display:flex;align-items:flex-start;gap:11px}
...
.np-deal-text strong{color:#BAE6FD;display:block;font-size:.88rem;font-weight:700;margin-bottom:2px;letter-spacing:-.01em}
...
.np-email{width:100%;padding:12px 15px;background:rgba(255,255,255,.06);border:1px solid rgba(14,165,233,.22);border-radius:11px;color:#fff;font-size:.875rem;font-family:inherit;outline:none;transition:border-color .2s,box-shadow .2s;box-sizing:border-box}
.np-email::placeholder{color:rgba(255,255,255,.28)}
.np-email:focus{border-color:rgba(14,165,233,.55);box-shadow:0 0 0 3px rgba(14,165,233,.1)}
.np-email.np-error{border-color:#f87171;box-shadow:0 0 0 3px rgba(248,113,113,.1)}

.np-cta{width:100%;padding:14px;background:linear-gradient(135deg,#075985,#0284C7,#0EA5E9);border:none;border-radius:11px;color:#fff;font-size:.9rem;font-weight:700;cursor:pointer;transition:opacity .15s,transform .15s;font-family:inherit;letter-spacing:-.01em;box-shadow:0 4px 20px rgba(14,165,233,.4)}
.np-cta:hover{opacity:.92;transform:translateY(-1px);box-shadow:0 6px 28px rgba(14,165,233,.5)}
