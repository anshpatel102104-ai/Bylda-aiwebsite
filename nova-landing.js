...
(function () {
  ...
  function initCanvas() {
    ...
    const blobs = [
      { x:0.15, y:0.20, r:0.55, c:'rgba(99,102,241,0.13)',  dx:0.00012, dy:0.00008 },
      { x:0.80, y:0.15, r:0.45, c:'rgba(168,85,247,0.10)',  dx:-0.00009,dy:0.00011 },
      { x:0.50, y:0.70, r:0.60, c:'rgba(236,72,153,0.08)',  dx:0.00008, dy:-0.00010},
      { x:0.10, y:0.80, r:0.40, c:'rgba(34,211,238,0.07)',  dx:0.00010, dy:-0.00007},
      { x:0.90, y:0.65, r:0.38, c:'rgba(99,102,241,0.08)',  dx:-0.00011,dy:-0.00009},
    ];
