...
const ENTRIES = {
  ...
  '/behavioral-sales-intelligence': { changefreq: 'monthly', priority: '0.9' },
  '/ai-sales-call-analysis': { changefreq: 'monthly', priority: '0.9' },
  '/ai-sales-coaching': { changefreq: 'monthly', priority: '0.9' },
  '/sales-call-auditing': { changefreq: 'monthly', priority: '0.9' },
  '/sales-performance-analytics': { changefreq: 'monthly', priority: '0.9' },
  '/for-sales-managers': { changefreq: 'monthly', priority: '0.9' },
  '/for-sales-reps': { changefreq: 'monthly', priority: '0.9' },
  '/behavior-graph': { changefreq: 'monthly', priority: '0.8' },
  '/deal-intelligence': { changefreq: 'monthly', priority: '0.8' },
  '/integrations/hubspot': { changefreq: 'monthly', priority: '0.8' },
  '/integrations/salesforce': { changefreq: 'monthly', priority: '0.8' },
  '/vision': { changefreq: 'monthly', priority: '0.8' },
  '/questions': { changefreq: 'weekly', priority: '0.9' },
  '/objection-handling-analysis': { changefreq: 'monthly', priority: '0.8' },
  '/discovery-call-analysis': { changefreq: 'monthly', priority: '0.8' },
  '/demo-call-analysis': { changefreq: 'monthly', priority: '0.8' },
  '/pricing-call-analysis': { changefreq: 'monthly', priority: '0.8' },
  '/meddpicc-call-analysis': { changefreq: 'monthly', priority: '0.8' },
  '/challenger-sale-call-analysis': { changefreq: 'monthly', priority: '0.8' },
  '/nepq-call-analysis': { changefreq: 'monthly', priority: '0.8' },
